        ...
        <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
                ...
                {currentTab === 'documents' && (
                    <View style={styles.tabContent}>
                        ...
                        <View style={[styles.uploadSection, { backgroundColor: theme.cardBg, borderColor: theme.border }]}>
                            ...
                            <Text style={[styles.uploadHint, { color: theme.textSecondary }]}>Maximum 200MB • PDF only</Text>
                        </View>
                                ...
                                {uploadedDocs.map((doc, idx) => (
                                    <View key={idx} style={[styles.docCard, { backgroundColor: theme.cardBg, borderColor: theme.border }]}>
                                        ...
                                        <View style={styles.docDetails}>
                                            ...
                                            <Text style={[styles.docMeta, { color: theme.textSecondary }]}>{Math.round(doc.size / 1024)} KB • Just now</Text>
                                        </View>
                        ...
                        {!fileName ? (
                            ...
                            <View style={styles.chatContainer}>
                                ...
                                <View style={[styles.inputSection, { borderTopColor: theme.border }]}>
                                    ...
                                    >
                                        <Text style={[styles.sendIcon, { opacity: inputText.trim() ? 1 : 0.3 }]}>➤</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        )}
            ...
            <View style={[styles.bottomNav, { borderTopColor: theme.border }]}>
                <TouchableOpacity
                    ...
                    onPress={() => setCurrentTab('documents')}
                >
                    <Text style={[styles.navIcon, { color: currentTab === 'documents' ? theme.accent : theme.textSecondary }]}>📁</Text>
                ...
                >
                    <Text style={[styles.navIcon, { color: currentTab === 'chat' ? theme.accent : theme.textSecondary }]}>💬</Text>
                ...
                >
                    <Text style={[styles.navIcon, { color: currentTab === 'session' ? theme.accent : theme.textSecondary }]}>⚙️</Text>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingTop: Platform.OS === 'ios' ? 0 : 50,  // Manual padding for Android status bar
